...
/*
Exercise Easy: Change equilateral triangle to right triangle
#include<iostream>
#include<glad/glad.h>
#include<GLFW/glfw3.h>
...
/*
Exercise Easy: Draw points instead of triangle
#include<iostream>
#include<glad/glad.h>
#include<GLFW/glfw3.h>
...
int main()
{
	...
	// Create a GLFWwindow object of 800 by 800 pixels, naming it "YoutubeOpenGL"
	GLFWwindow* window = glfwCreateWindow(800, 800, "GL_Points", NULL, NULL);
	// Error check if the window fails to create
	if (window == NULL)
	{
		std::cout << "Failed to create GLFW window" << std::endl;
	...
	glPointSize(10.0f); // Sets the point size to 10 pixels
	// Main while loop
	while (!glfwWindowShouldClose(window))
	{
		// Specify the color of the background
...
*/
/*
Exercise Medium: Make it a square
...
int main()
{
	...
	GLfloat vertices[] =  // x, y, z
	{
		-0.5, 0.5f * float(sqrt(3)) * 2 / 3, 0.0f, // Upper Left Corner
...
*/
/*
Exercise Medium: make Vao and Vbo into array size of 1
#include <iostream>
#include <glad/glad.h>
#include <GLFW/glfw3.h>
...
/*
Exercise Hard: Make Square using gl_line_loop
#include <iostream>
#include <glad/glad.h>
#include <GLFW/glfw3.h>
